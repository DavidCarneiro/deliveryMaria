...
$.ajax({
        type: "GET",
        url: "http://mariaburgueira.com.br/webservice/produtos.php",
        timeout: 8000,
		crossDomain: true,
...
function listaItens(objeto){    
   ...
   $.each(objeto, function (i, name) {
		...
		if(name.entrega == 0){
			...
			li += '<li>'+ 
			'<img src="http://mariaburgueira.com/css/produtos/'+name.img+'" width="100%" height="100%" class="ui-li-thumb"><h2 class="controler">'+name.nome+' '+ promocao +'</h1>'+
			...
			'</li>';
				...
				li += '<li>' + 
				'<img src="http://mariaburgueira.com/css/produtos/'+name.img+'" width="100%" height="100%" class="ui-li-thumb"><h2 class="controler">'+name.nome + '</h1>'+
				'<p id="texto">'+name.desc+'</p>'+
				'<p>R$'+name.valorp+'</p>'+
				'</li>';
			}
			...
			'<img src="http://partiupizza.com/css/produtos/'+name.img+'" width="100%" height="100%" class="ui-li-thumb"><h2 class="controler">'+name.nome+' '+ promocao +'</h1>'+
			'<p id="texto">'+name.desc+'</p>'+
			'<p>R$'+name.valorb+'B R$'+name.valorp+'P R$'+name.valorm+'M R$'+name.valorg+'G</p>'+
			'</a></li>';
			}
				...
				li += '<li><a href="#" id="' + i + '" class="info-go">' + 
				'<img src="http://partiupizza.com/css/produtos/'+name.img+'" width="100%" height="100%" class="ui-li-thumb"><h2 class="controler">'+name.nome + '</h1>'+
				'<p id="texto">'+name.desc+'</p>'+
				'<p>R$'+name.valorp+'</p>'+
				'</a></li>';
			}
	...
	$(document).on("pagebeforeshow", "#ped-page", function () {
		...
		$('#control').html('<b style="font-size:14px;">'+info['nome']+' '+promocao+'</b><br>'+info['desc']+'<br>R$:'+info['valorp']);
